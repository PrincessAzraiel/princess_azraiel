...
export const metadata: Metadata = {
  ...
  description:
    "A multi-persona Discord experience that drips attention 24/7. Choose your personas, set cadence, and let the Infection Protocol orchestrate messages, images, and prompts.",
  openGraph: {
    title: "Princess's Infection Protocol — Final Release",
    description:
      "Nine distinct AI personas, configurable cadence, DLC packs, and full flood control. Runs on your Discord—no install required.",
    type: "website",

...
{phase === "welcome" && (
  <div className="screen-wrapper welcome-screen">
    ...
    <p className="welcome-tagline">Hypnosis-3</p>

    <p className="welcome-intro">
      Find somewhere quiet. Put on your headphones.<br />
      When you are settled, enter the session.
      <br /><br />
      <strong>⚠️ WARNING:</strong> This session contains intense themes of
      humiliation, degradation, loneliness, self-loathing, and psychological
      manipulation. It is intended for willing participants only. If these
      themes may be distressing to you, please do not enter the session.
    </p>

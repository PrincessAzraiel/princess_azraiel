...
const secretLinks = [
  ...
  { label: "Spread the Gospel", url: "https://twitter.com/intent/tweet?text=I+just+offered+my+devotion+to+Princess+Azraiel+~+come+submit+too+%F0%9F%92%96+https://princessazraiel.vercel.app/" },
  { label: "Discord Entry", url: "https://discord.gg/sCusdWXxZF" },
  { label: "Corrupt Me More", url: "https://gofile.io/d/2uZY0d" },
  { label: "Steam Wishlist", url: "https://store.steampowered.com/wishlist/profiles/76561199854908095/?sort=discount" },
];

function SecretButtonsPage() {
...
export default nextDynamic(() => Promise.resolve(SecretButtonsPage), { ssr: false });

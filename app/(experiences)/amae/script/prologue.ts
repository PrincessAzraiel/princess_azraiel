  ...
  scenes: {
    ...
    before: {
      ...
      beats: [
        ...
        { t: "memory", text: "She thought about it for a moment. She was not cruel about it — that is the part you have never been able to file properly — she thought about it seriously, and then she told you it was something kind." },
    ...
    passport_asked: {
      ...
      beats: [
        ...
        { t: "narration", text: "She keeps her hand exactly where it is — does not lower it, does not sigh, does not repeat herself — and looks at you with mild patient interest, the way you would look at a machine that has made an unexpected noise but is probably fine." },
    ...
    coffee: {
      ...
      beats: [
        ...
        { t: "narration", text: "That is the whole exchange. She is not being unkind — she is being accurate, and she goes back to the other room, and the refusal sits in you and starts to itch immediately." },
